...
translations = {
    "en": {
        ...
        "sql_query": "SQL Query",
        "run_query": "Run Query",
        "data_source": "Data Sources: World Bank, IMF DataMapper, The Economist Big Mac index",
        "last_updated": "Last Updated: run `python download_data.py` to refresh",
    ...
    "zh": {
        ...
        "sql_query": "SQL查询",
        "run_query": "运行查询",
        "data_source": "数据来源：世界银行、IMF DataMapper、The Economist Big Mac index",
        "last_updated": "最后更新：运行 `python download_data.py` 刷新数据",
